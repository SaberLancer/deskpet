...
require$$1$2.contextBridge.exposeInMainWorld("ipcRenderer", withPrototype(require$$1$2.ipcRenderer));
require$$1$2.contextBridge.exposeInMainWorld("electronStore", {
  get: (key) => {
